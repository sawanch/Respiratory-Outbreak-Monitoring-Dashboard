package com.outbreaktracker.api.common.config;
 ...
 * Only enabled when spring.cache.redis.enabled=true
 * When disabled, caching is bypassed and requests go directly to database
